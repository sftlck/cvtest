...
def detect_lines(frame):
    ...
    if hcircle is not None:
        ...
        for (x, y, r) in hcircle:
            ...
            cv2.circle(frame, (x, y), circle_tolerance, (0, 255, 0), 1)                     ########CÍRCULO EXTERNO
            cv2.circle(frame, (x, y), 2, (0, 255, 0), 1)                                    ########CENTRO DO CÍRCULO
            cv2.circle(black_foreground, (x, y), circle_tolerance, (0, 255, 0), 1)          ########CÍRCULO EXTERNO
            ...
            if circle_detected and circle_data and needle_origin and needle_end:
                ...
                if length > 0:
                    ...
                    if distance2 > 0:
                        ...
                        #cv2.imshow('CROPPED',frame[80:280, 150:330])
                        ...
                        elif current_angle_deg_ref == 0 : current_angle_deg_ref = 0.000001
